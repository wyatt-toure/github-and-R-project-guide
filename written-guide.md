...
GitHub is a service owned by Microsoft that allows one to store Git repositories online. These tools allow us to maintain a record of file changes over time with each version being fully accessible should they need to be recalled in the future. GitHub works by tracking changes that are made on your local *Git* directory.
