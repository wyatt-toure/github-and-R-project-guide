...
Integrating Rmarkdown outputs with GitHub Pages allows one to create reader-friendly sites for your projects. With GitHub pages a website can be generated from a directory of HTML files. This requires a file called `index.html` to be present in the directory the site is built from which can also be made using Rmarkdown.
